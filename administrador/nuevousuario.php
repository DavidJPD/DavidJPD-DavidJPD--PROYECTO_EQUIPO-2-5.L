...
<body>
   ...
   <section >
     ...
     <form action="../acciones/guardarusuario.php" method="post">
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <label style="color: #ffffff"; class="form-label" for="form2Example11">Correo electrónico</label>
                  </div>

                  <div class="form-outline mb-4">
                    <input type="password" id="form2Example22" class="form-control" name="password" />
                    <label style="color: #ffffff"; class="form-label" for="form2Example22">Password</label>
                  </div>
                  <div class="form-outline mb-4">
                    ...
                    <label style="color: #ffffff"; class="form-label" for="form2Example22">Tipo de usuario</label>
                  </div>
