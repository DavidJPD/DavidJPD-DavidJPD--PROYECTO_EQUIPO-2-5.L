...
<body>
    ...
    <section class="bg-gray d-flex justify-content-center aling-item-center vh-100">
        ...
        <div class="col">
            <h1>Administración del inventario</h1> 
     <a href="../administrador/nuevoproducto.php" class="btn btn-primary">Nuevo</a> 
      ...
      <thead>
        ...
        <tbody>
            <?php
                ...
                $usuario=new Usuario();
                $resultado=$usuario->Obtenerinventario();
                foreach ($resultado as $item) {
                    ...
                    echo '<td><a href="../acciones/eliminarproducto.php?id='.$item["id"].'"><img src="../images/Cancelar.png"/></a></td>';
                    echo '<td><a href="../administrador/editarproducto.php?id='.$item["id"].'"><img src="../images/Editar.png"/></a></td>';
                }
            ?>
        </tbody>
      </table> 
